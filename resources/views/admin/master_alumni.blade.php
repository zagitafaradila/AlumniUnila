...
@section('title', 'Tracer | Master Alumni')
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Daftar Surveyor</h5>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <button id="add" type="button" class="btn btn-outline-success"><i class="fas fa-plus"></i> Add</button>                
                <button id="removeCheck" type="button" class="btn btn-outline-danger"><i class="fas fa-trash"></i> Hapus Terpilih</button>
              </div>
              <!-- ./card-body -->
            </div>
            <!-- /.card -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group col-md-6">
                <span>Wisuda</span>
                <input class="form-control required datepicker" type="date" id="wisuda" name="wisuda">
                <span class="valid-msg" id="wisudamsg"></span>
              </div>
              <div class="clearfix"></div>
              <div class="form-group col-md-6">
                <span>Telepon</span>
...
@section('js')   
  ...
  <script src="{{URL::to('../')}}/Scripts/master_alumni.js"></script>
@stop